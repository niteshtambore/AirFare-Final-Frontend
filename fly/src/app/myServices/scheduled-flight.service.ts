...
export class ScheduledFlightService {
  ...
  addScheduleFlight(scheduleFlight:ScheduledFlight,srcAirport: string ,dstnAirport: string | number | boolean,deptDateTime: string | number | boolean,arrDateTime: string | number | boolean){
