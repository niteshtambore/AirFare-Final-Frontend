...
import { ScheduledFlight } from '../myClass/scheduled-flight'; 
import { Router } from '@angular/router';
import { ScheduledFlightService } from '../myServices/scheduled-flight.service';
...
export class ModifyScheduledFlightComponent implements OnInit {
  ...
  //   this.service.searchScheduledFlight(this.scheduleFlightId).subscribe((
  //     scheduleFlight:ScheduledFlight)=>this.scheduleFlight=scheduleFlight);
  // }
